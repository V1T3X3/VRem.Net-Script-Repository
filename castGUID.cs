...
public class castGUID : MonoBehaviour
{
    ...
    public void transmitIdent()
    {
        ...
        sock.interactionLayers = InteractionLayerMask.GetMask("InteractionLock"); 
        obj.GetComponent<XRGrabInteractable>().interactionLayers = InteractionLayerMask.GetMask("InteractionLock");
    }
    ...
    public void nullify()
    {
        ...
        obj.GetComponent<XRGrabInteractable>().interactionLayers = InteractionLayerMask.GetMask("WaitingforInteraction"); 
        XRSocketInteractor sock = GetComponent<XRSocketInteractor>();
        sock.interactionLayers = InteractionLayerMask.GetMask("WaitingforInteraction"); 
